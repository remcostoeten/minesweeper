...
export const usePlaceBet = (bet: number) => {
  ...
  const handlePlaceBet = async () => {
    ...
    if (balance < bet) {
      toast("I'm sorry, but it seems your balance isn't sufficient to place that bet. Please consider topping up your balance or adjusting your bet amount. 😔")
      return;
    }
    ...
    if (bet <= 0) {
      ...
      setTimeout(() => {
        toast("at least... I don't think so, it would be a good idea to charge you to play though... 👽");
      }, 5500);
      return;
    }
